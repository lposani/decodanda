...
In addition, Decodanda exposes a series of functions to analyze the **geometrical properties of neural code**, such as the 
Cross-Condition Generalization Performance (_CCGP_, Bernardi et al. 2020), Parallelism Score, and more ([notebook](https://github.com/lposani/decodanda/blob/notebooks/master/CCGP.ipynb)). Also see [this class material](https://colab.research.google.com/drive/1thM20lU6grvOQcjDXuQ9IwLB3agsMJmH#scrollTo=ya1LtxcYM15v) [![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/1thM20lU6grvOQcjDXuQ9IwLB3agsMJmH#scrollTo=ya1LtxcYM15v) on how to use decoding and CCGP to retrieve the representational geometry.
...
- [CCGP and geometrical analysis](https://github.com/lposani/decodanda/blob/master/notebooks/CCGP.ipynb) [![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/lposani/decodanda/blob/master/notebooks/CCGP.ipynb)
