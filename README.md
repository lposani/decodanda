...
The Decodanda constructor takes different parameters that can be used to preprocess or filter the data
...
| `exclude_silent`            | `bool`<br/><br/>default: `False`                                                                                                                                          | Excludes all population vectors with only zeros at a specific time from the analysis.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
