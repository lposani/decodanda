...
Cross-Condition Generalization Performance (_CCGP_, Bernardi et al. 2020), Parallelism Score, and more ([notebook](https://github.com/lposani/decodanda/blob/notebooks/master/CCGP.ipynb)).
